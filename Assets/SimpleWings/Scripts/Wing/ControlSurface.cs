...
namespace Warglobe
{
   ...
   public class ControlSurface : MonoBehaviour
   {
      ...
      [SerializeField] [Range(-1, 1)] private float m_DeflectionInput = 0.0f;
      ...
      private void Start()
      {
         ...
         // Set proper rotation direction
         _turnAxis = AxisToVector(_axis);
      }
      ...
      private void FixedUpdate()
      {
         ...
         transform.Rotate(_turnAxis, m_CurrentAngle, Space.Self);
