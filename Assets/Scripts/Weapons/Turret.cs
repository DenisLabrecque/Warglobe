...
namespace Warglobe
{
   ...
   public class Turret : MonoBehaviour, IFireable, ISwitchable
   {
      ...
      public bool LaunchAuthority => throw new System.NotImplementedException();

      public float HitProbability => throw new System.NotImplementedException();
      ...
      public bool Fire()
      {
         if (IsAimed && IsReloadTimeElapsed)
         {
            _reloadTimer = 0f;
